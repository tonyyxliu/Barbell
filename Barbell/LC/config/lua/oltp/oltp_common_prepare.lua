...
function execute_point_selects(table_id)
    ...
    for i = 1, sysbench.opt.point_selects do
        ...
        connection:bind_params(table_id, "point_selects", 1, get_id())
...
local function execute_range(key, table_id)
    ...
    for i = 1, sysbench.opt[key] do
        ...
        -- connection:query(command)
        connection:bind_params(table_id, key, 1, start_id)
        connection:bind_params(table_id, key, 2, end_id)
        connection:query_prepare(table_id, key)
    end
end
